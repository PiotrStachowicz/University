...
(define mt-env empty)
(define (extend-env [env : Env] [x : Symbol] [v : Exp]) : Env
  (cons (bind x v) env))
(define (lookup-env [n : Symbol] [env : Env]) : Exp
...
; przykład:
; (letE 'x (numE 12) (lamE 'y (opE (add) (varE 'y) (numE 2))))
