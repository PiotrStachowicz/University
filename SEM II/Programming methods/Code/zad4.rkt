...
(define (cukrzyca [e : Exp]) : Exp
  (type-case Exp e
    [(numE n) (numE n)]
    [(opE op l r) (opE op (cukrzyca l) (cukrzyca r))]
    [(ifE b l r) (ifE (cukrzyca b) (cukrzyca l) (cukrzyca r))]
    [(condE cs) (cond->if cs)]))

(define (run [e : S-Exp]) : Value
  (eval (cukrzyca (parse e))))
